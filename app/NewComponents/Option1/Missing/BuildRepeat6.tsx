// components/Step6.tsx
import React, { useEffect, useState } from 'react';
import { FaCog } from 'react-icons/fa';

interface BuildRepeat6Props {
    onComplete?: () => void;
}

const BuildRepeat6 = ({ onComplete }: BuildRepeat6Props) => {
    ...
    useEffect(() => {
        // Processing animation logic - similar to BuildRepeat7
                        ...
                        <div className="mb-4">
                            <div className="flex items-center gap-2 mb-2">
                                ...
                                <h2 className="text-sm font-semibold text-gray-700">
                                    Behind the Scenes: Risk Analysis Process
                                </h2>
                            </div>
                            <p className="text-gray-600 text-xs mb-2">
                                To perform the risk analysis, Floxa:
                            </p>
                        </div>
