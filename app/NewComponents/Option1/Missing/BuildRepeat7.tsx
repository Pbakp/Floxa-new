...
interface BuildRepeat7Props {
    onComplete?: () => void;
}

const BuildRepeat7 = ({ onComplete }: BuildRepeat7Props) => {
    ...
    return (
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-sm p-2">
            {showProcessing && (
                    ...
                    <div className="bg-white w-full">
                        <div className="mb-4">
                            ...
                            <p className="text-gray-600 text-xs mb-2">
                                For the final confirmation, Floxa is performing cross-platform integration tasks:
                            </p>
                        </div>
            ...
            {showContent && (
                <div
                    className={`transform transition-all duration-1000 ease-out ${showContent ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
                        }`}
                >
                </div>
            )}
