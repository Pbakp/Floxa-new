...
const TeamSelectionComponent = ({ onProcessingComplete }: TeamSelectionComponentProps) => {
    const processingSteps = [
        { text: "Querying employee profiles from SharePoint for skills matching" },
        { text: "Reviewing project history and experience in Dynamics" },
        { text: "Checking staff availability via Outlook calendars" },
        { text: "Assessing client-specific experience from HubSpot data" },
        { text: "Analyzing past project performance metrics in Jira" }
    ];
    ...
    useEffect(() => {
        // Processing animation logic - same as BuildRepeat1 and BuildRepeat2
                    ...
                    <div className="bg-white flex items-center justify-center z-50">
                        <div className="bg-white w-full">
                            <div className="mb-6 p-6">
                                ...
                                <p className="text-gray-600 text-sm mb-2">I'll analyze team member profiles and availability to recommend the best candidates for the TechCorp project based on skills, experience, and availability.</p>
                                <p className="text-gray-600 text-sm">Querying employee data across SharePoint, Dynamics, Outlook, HubSpot, and Jira to identify optimal team composition...</p>
                            </div>
